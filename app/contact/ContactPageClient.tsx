...
const ContactPageClient = () => {
  ...
  const contactItems = [
    {
      ...CONTACT_INFO[0],
      label: get("contact_address", CONTACT_INFO[0].label),
    },
    {
      ...CONTACT_INFO[1],
      label: get("contact_phone", CONTACT_INFO[1].label),
      href: `tel:${get("contact_phone", "+22901283102").replace(/\s/g, "")}`,
    },
    {
      ...CONTACT_INFO[2],
      label: get("contact_email", CONTACT_INFO[2].label),
      href: `mailto:${get("contact_email", "info.matloc@gmail.com")}`,
    },
  ];
  ...
  return (
    <>
      {/* Section Hero */}
      <PageHero
        title={get("contact_hero_title", t("pages.contact"))}
        url={images.get("img_banner_contact", "/assets/images/banner.jpg")}
      />
